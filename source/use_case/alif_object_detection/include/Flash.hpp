...
int32_t ospi_flash_read_collection(FaceEmbeddingCollection &collection)
{
    ...
    serializedData.reserve(2200);  // Reserve space for 1024 uint16_t entries
